...
import com.soarex.autofactory.kotlin.plugin.fir.CachingFactoryClassId
...
fun FirClass.hasCachingFactory(session: FirSession): Boolean {
    return status.isData && hasAnnotation(CachingFactoryClassId, session)
}